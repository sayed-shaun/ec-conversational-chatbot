...
The offer of help in rule 2 is scoped to greetings, and barred from the end of
an informational answer, because a sentence supplied by the prompt is one the
model will reach for everywhere: it had become a sign-off on every factual
reply, and the whole reply to "ok".
"""
